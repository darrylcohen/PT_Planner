...
var buildStations = function (stations) {
...
$(document).ready(function() {
  ...
  var originStations = document.createElement("select")
  originStations.addEventListener( "change", function() {
    origin = this.value
  })

  var destinationStations = document.createElement("select")
  destinationStations.addEventListener( "change", function() {
    destination = this.value
  })

  document.getElementById("FromTrainContainer").appendChild(buildStations(originStations))
  document.getElementById("ToTrainContainer").appendChild(buildStations(destinationStations))
